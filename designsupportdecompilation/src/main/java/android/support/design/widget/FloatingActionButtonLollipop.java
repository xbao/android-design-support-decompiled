...
class FloatingActionButtonLollipop extends FloatingActionButtonHoneycombMr1 {
   ...
   void setPressedTranslationZ(float translationZ) {
      ...
      stateListAnimator.addState(PRESSED_ENABLED_STATE_SET, this.setupAnimator(ObjectAnimator.ofFloat(this.mView, "translationZ", new float[]{translationZ})));
      stateListAnimator.addState(FOCUSED_ENABLED_STATE_SET, this.setupAnimator(ObjectAnimator.ofFloat(this.mView, "translationZ", new float[]{translationZ})));
      stateListAnimator.addState(EMPTY_STATE_SET, this.setupAnimator(ObjectAnimator.ofFloat(this.mView, "translationZ", new float[]{0.0F})));
